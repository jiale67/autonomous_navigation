...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subJoystick = nh.subscribe<sensor_msgs::Joy>("/joy1", 5, joystickHandler);

  ros::Subscriber subClearing = nh.subscribe<std_msgs::Float32>("/cloud_clearing1", 5, clearingHandler);
